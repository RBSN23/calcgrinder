...
Always write acceptance criteria in English using the Given/When/Then format:
...
- [ ] Given the API is unreachable, when the user submits the form, then an error message is shown and the input is preserved
